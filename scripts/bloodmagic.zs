...
mods.bloodmagic.Alchemy.addRecipe(<Thaumcraft:ItemShard:4>*5,[<minecraft:bone:1>,<magicalcrops:magicalcrops_2AccioEssence>,<minecraft:bone:1>,<minecraft:iron_ingot>,<minecraft:iron_ingot>],2,5000);
